...
The difference in the coefficient on cigs is 0.084. This is because the multiple regression controls for more factor that affect both `cigs` and `bwght`. The coefficient represent the average change in ounces of a baby's birth weight for the mother smoking one additional cigarette.
